...
<div class="app-container">
  <div class="sidebar">
    ...
    <div class="account-info">
      <div class="account-info-picture">
        <img src="../resources/images/profile.png" alt="Account">
      </div>
  ...
  <div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">Liste of Books</h1>
    ...
    <div class="app-content-actions" >
      <form class = "fff" method="post">
        <input class="search-bar" placeholder="Search..." type="text" name="search" id="search" >
        <button class="app-content-headerButtonll">Search</button>
      </form>
        ...
        <div class="filter-button-wrapper">
          ...
          <div class="filter-menu">
            ...
            <select>
              ...
              <option>Discipline</option>                     <option>Newest</option>
              <option>Oldes</option>
    ...
    <div class="products-area-wrapper tableView">
      ...
      <c:choose>
        <c:when test="${!empty book.title}">
          <div class="products-row">
            ...
            <div class="product-cell image">
              <img src="../resources/images/saved_resource" alt="product">
              <span>${book.title}</span>
            </div>
            <div class="product-cell category"><span class="cell-label">Category:</span>${book.category}</div>
            <div class="product-cell status-cell">
              <span class="cell-label">Status:</span>
              <c:choose >
                <c:when test="${book.status=='available'}">
                  <span class="status active">${book.status}</span>
                </c:when>
                <c:otherwise>
                  <span class="status disabled">${book.status}</span>
                </c:otherwise>
              </c:choose>
            </div>
            <div class="product-cell sales"><span class="cell-label">Author:</span>${book.author}</div>
            <div class="product-cell stock"><span class="cell-label">Stock:</span>${book.nbavailable}</div>
            <div class="product-cell price"><span class="cell-label">Price:</span>remove it</div>
          ...
          <c:forEach  items="${books}" var="val">
            <div class="products-row">
              ...
              <div class="product-cell status-cell">
                <span class="cell-label">Status:</span>
                <c:choose >
                  <c:when test="${val.status=='available'}">
                    <span class="status active">${val.status}</span>
                  </c:when>
                  <c:otherwise>
                    <span class="status disabled">${val.status}</span>
                  </c:otherwise>
                </c:choose>
              </div>
      ...
      <%--          <button class="app-content-headerButtonl">order Book</button>--%>
      <%--      </div>--%>
